...
> Примечание: в текущей версии — учебная реализация auth; в планах миграция на bcrypt/argon2.
...
## Безопасность
- **Пароли:** заменить текущий легаси на bcrypt/argon2 + соль
...
- легаси/учебная версия для паролей → bcrypt/argon2
- Секреты/ключи в ```.env``` (+ ```server/.env```)
